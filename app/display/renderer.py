...
def render_pet_screen(pet, theme="light"):
    background, foreground = theme_colors(theme)
    ...
    draw_centered_text(draw, 82, face, face_font, foreground)
    ...
    for x, (label, value) in zip((12, 122, 232), bottom_stats(pet)):
        draw.text((x, 146), f"{label} {value}", font=medium_font, fill=foreground)
